      ...
      <Card className="max-w-3xl w-full">
            ...
            <div className="flex-1 space-y-4">
              <div>
                <h3 className="font-semibold text-lg mb-1">
                  About {matchedDog.name}
                </h3>
                <ul className="space-y-2">
                  <li className="flex justify-between">
                    <span className="text-muted-foreground">Age:</span>
                    <span className="font-medium">
                      {getAgeText(matchedDog.age)}
                    </span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-muted-foreground">Breed:</span>
                    <span className="font-medium">
                      {formatBreedName(matchedDog.breed)}
                    </span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-muted-foreground">Location:</span>
                    <span className="font-medium">
                      Zip Code {formatZipCode(matchedDog.zip_code)}
                    </span>
                  </li>
                </ul>
              </div>
              <div className="bg-secondary/50 p-4 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  to start the adoption process for {matchedDog.name}. Every dog
        ...
        <CardFooter className="flex flex-col sm:flex-row gap-3 justify-between">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            ...
            <Button onClick={handleStartOver} className="gap-2 flex-1">
